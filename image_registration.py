...
def registration(moving_img, fixed, reg_type):
    ...
    if reg_type == RIGID:
        ...
        if reg.inputs.initial_moving_transform_com:
            ...
            reg.inputs.number_of_iterations = ([[10000, 5000, 1000, 1000],
                                                [5000, 1000, 1000, 1000],
                                                [100, 75, 50]])
            reg.inputs.shrink_factors = [[7, 5, 2, 1], [6, 4, 2, 1], [100, 50, 50]]
            reg.inputs.smoothing_sigmas = [[6, 4, 1, 0], [5, 3, 1, 0], [1, 0.5, 0]]
